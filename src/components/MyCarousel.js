        ...
        return (
            <View>
                ...
                <View style={{flexDirection: 'row', alignContent: 'center'}}>
                    {this.pagination}
                    <Button title='Lihat Semua' type="clear" buttonStyle={{height: 30}} containerStyle={{marginLeft: Dimensions.get('window').width/4, marginRight: 2}} onPress={this.props.lihatSemua}/>
                    {/* <TouchableOpacity onPress={this.props.lihatSemua}>
                        <View style={{marginRight: 0, justifyContent: 'center', padding: 10}}>                    
