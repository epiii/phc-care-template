...
export default class CardDoctorSelect extends Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    render() {
        ...
        return (
            <View style={{flexDirection: 'row', width: '95%', alignSelf: 'center', borderBottomWidth: 1, borderBottomColor: '#F6F6F6', paddingBottom: 10, marginBottom: 10 }}>
                <Image style={{width: 50, height: 50, borderRadius: 50}} source={this.props.pic}/>
                <View style={{marginLeft: 20, width: '60%', alignSelf: 'center'}}>
                    <Text style={styles.h0}>{this.props.doctor}</Text>
                    <Text style={styles.h2}>{this.props.spesialis}</Text>
                </View>
