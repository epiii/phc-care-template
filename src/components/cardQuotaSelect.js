...
export default class CardQuotaSelect extends Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    render() {
        ...
        return (
            <View style={{backgroundColor: '#F4F4F4', borderRadius: 5, paddingTop: 10, paddingBottom: 10, width: '95%', flexDirection: 'row', alignSelf: 'center', marginBottom: 10, marginTop: 10}}>
