...
export default class CekAntrian extends Component {
    constructor(props) {
        super(props);
        this.state = {
            test : '',
    ...
    render () {
        return (
            <SafeAreaView style={styles.container}>                                 
                <Header
                    placement="left"
                    leftComponent={<LeftHeaderBack title={'Cek Antrian Poli'} onBack={() => this.props.navigation.goBack()}/>}
                    ...
                    <View style={styles.bottomContainer}>
                        <View style={styles.cardform}>
                            ...
                            <View style={styles.bottomContainer2}>
                                <Button onPress={() => this.cekAntrian()} buttonStyle={{width: '90%', alignSelf: 'center', backgroundColor: '#2C338B'}} title='Cek Antrian'/>
                            </View>
                        </View>
                        <MyView hide={this.state.hide} style={styles.cardform}>
                            <CardCekAntrian 
                                doctor={'Rini Andriani, Dr'} 
                                spesialis={'Spc. Anak'}
