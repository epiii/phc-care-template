...
export default class Pendaftaran2Revised extends Component {
    constructor(props) {
        super(props);
        this.state = {
            test : '',
                ...
                <ScrollView style={{width: '100%'}}>
                    <View style={styles.bottomContainer}>
                        ...
                        <View style={styles.cardform}>
                            <View style={{marginLeft: 10, padding: 10, marginTop : -10, borderRadius: 5, backgroundColor: '#CAD1D7', width : 150}}>
                                <Text style={{color : '#172B4D', fontSize: 12, fontFamily: 'Montserrat-Regular'}}>Data Berobat</Text>
                            </View>
                            {/* <Input
                                //value={values.email}
                                label={'Email'}
                                ...
                                inputStyle={{borderRadius: 15, borderWidth: 1, fontSize: 15, borderColor: '#594bb4', flex: 1, marginRight: 45}}  
                            /> */}
                            {/* pilihan textfield a */}
                            <TextField
                                label='No. Rekam Medis'
                                labelTextStyle={{fontSize: 14, fontFamily: 'Montserrat-LightItalic'}}
                            ...
                            <TextField
                                ...
                                labelTextStyle={{fontSize: 14, fontFamily: 'Montserrat-LightItalic'}}
                                //containerStyle={styles.search}
                                containerStyle={[styles.search,{marginTop: 10}]}
                            ...
                            />                 
                            <View style={styles.bottomContainer}>
                                <Button onPress={() => this.props.navigation.navigate('KonfirmasiPendaftaran')} buttonStyle={{width: '90%', alignSelf: 'center', backgroundColor: '#2C338B'}} title='Lanjutkan'/>
                            </View>
                        </View>
                    </View>
                </ScrollView>
