...
export default class PilihKlinik extends Component {
    constructor(props) {
        super(props);
        this.state = {
            test : '',
    ...
    _renderItem = (item) => {
        //console.error(item);
        return (
            <TouchableOpacity onPress={() => this.props.navigation.navigate('PilihPoli')}>
                <CardSelect 
    ...
    render () {
        return (
            <SafeAreaView style={styles.container}>                                 
                <Header
                    placement="left"
                    leftComponent={<LeftHeaderBack title={'Pilih Klinik'} onBack={() => this.props.navigation.goBack()}/>}
