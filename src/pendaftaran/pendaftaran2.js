...
export default class Pendaftaran2 extends Component {
    constructor(props) {
        super(props);
        this.state = {
            test : '',
                    ...
                    <View style={styles.bottomContainer}>
                        ...
                        <View style={styles.cardform}>
                            ...
                            <TextField
                                ...
                                containerStyle={[styles.search,{marginTop: 15}]}
                            ...
                            />                 
                            <View style={styles.bottomContainer}>
                                <Button onPress={() => this.props.navigation.navigate('Pendaftaran2Revised')} buttonStyle={{width: '90%', alignSelf: 'center', backgroundColor: '#2C338B'}} title='Lanjutkan'/>
                            </View>
                        </View>
                    </View>
                </ScrollView>
