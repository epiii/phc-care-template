...
export default class Akun2 extends Component {
    constructor(props) {
        super(props);
        this.state = {
            test : '',
    ...
    FirstRoute = () => (
        <CardProfileEdit 
            ...
            onEdit={() => alert('edit profil')}
        />
    );

    SecondRoute = () => (
        <Pengaturan 
            editprofil={() => alert('edit profil')}
            
            ubahsecurity={() => alert('ubah security')}
            ubahpassword={() => alert('ubah password')}
            lupapassword={() => alert('lupa password')}

            tentang={() => alert('tentang')}
            kebijakan={() => alert('kebijakan')}
            bantuan={() => alert('bantuan')}
